...
includes selected writing samples, documentation projects, and examples of
my work with developer documentation and documentation systems.
...
| [Skytree Python SDK Quick Start](ab-project/docs/pdfs/SkytreePythonSDKQuickStart.pdf) | Quick start | End-to-end developer workflow from authentication and data preparation through model training and results |
...
| [Skytree GUI Quick Start](ab-project/docs/pdfs/SkytreeGUIQuickStart.pdf) | Quick start | Hands-on machine-learning workflow from creating a project and preparing data through training, testing, and evaluating a model |
...
| [Skytree Single Node Installation](ab-project/docs/pdfs/SkytreeSingleNodeInstall.pdf) | Installation guide | Single-node Hadoop and Skytree deployment |
| [Upgrading Skytree](ab-project/docs/pdfs/UpgradingSkytree.pdf) | Upgrade guide | Software upgrade and migration procedures involving services, configuration, packages, and database changes |
...
| [Skytree Platform Release Notes](ab-project/docs/pdfs/SkytreePlatformReleaseNotes.pdf) | Release notes | Platform release information, changes, and product updates |
| [Skytree Server Release Notes](ab-project/docs/pdfs/SkytreeServerReleaseNotes.pdf) | Release notes | Server release information, changes, and product updates |

## Articles

I also write about technical writing, documentation systems, and projects
I've built.
...
The site and repository also give me a place to experiment with docs-as-code
workflows, static-site generation, documentation design, and other tools
related to technical communication and developer experience.
